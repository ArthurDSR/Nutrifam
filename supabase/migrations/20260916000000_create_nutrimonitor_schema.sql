-- ==============================================================================
-- NutriFam - Supabase Database Schema & Migrations
-- Versão com autenticação segura, integridade de e-mails e RLS por usuário
-- ==============================================================================
...
-- Suporte a atualizações de schema incrementais
