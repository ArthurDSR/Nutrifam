...
const translations = {
  pt: {
    ...
    'ai.geminiModelNotice': 'Modelo ativo: gemini-3.5-flash-lite (Visão multimodal, ultra rápido e gratuito no AI Studio)',
  ...
  en: {
    ...
    'ai.geminiModelNotice': 'Active model: gemini-3.5-flash-lite (Multimodal vision, ultra fast and free on AI Studio)',
  ...
  es: {
    ...
    'ai.geminiModelNotice': 'Modelo activo: gemini-3.5-flash-lite (Visión multimodal, ultra rápido y gratuito en AI Studio)',
    'ai.modelGemini': 'Modelo Google Gemini',
